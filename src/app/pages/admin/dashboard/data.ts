...
export const SellerProfileData = (t: any) => [
  {
    id: 1,
    icon: faUser,
    ...
    caption: "",
    link_title: "",
    link: "account-store-info",
    status: t("admin_shop.dashboard.status.completed"),
  },
  {
    id: 2,
    icon: faBoxesStacked,
    title: t("admin_shop.dashboard.title.warehouse_address"),
    caption: t("admin_shop.dashboard.caption.provide"),
    link_title: t("admin_shop.dashboard.link_title.warehouse_address"),
  ...
  },
  {
    ...
    caption: t("admin_shop.dashboard.caption.complete_all"),
    link_title: "",
