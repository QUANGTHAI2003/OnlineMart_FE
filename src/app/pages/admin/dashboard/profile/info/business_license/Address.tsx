...
const Address: React.FC<ISelectAddress> = React.memo(({ onAddressChange }) => {
    ...
    <Row gutter={32}>
      <Col span={12}>
        <S.FormField
          ...
          hasFeedback
          colon={false}
          label={<div className="font-bold">{t("admin_shop.shop_info.store_bus.city")}</div>}
          rules={[{ required: true }]}
        >
          <Select
            size="large"
        ...
        <S.FormField
          ...
          hasFeedback
          colon={false}
          label={<div className="font-bold">{t("admin_shop.shop_info.store_bus.district")}</div>}
          rules={[{ required: true }]}
        >
          <Select
            size="large"
      ...
      <Col span={12}>
        <S.FormField
          ...
          hasFeedback
          colon={false}
          label={<div className="font-bold">{t("admin_shop.shop_info.store_bus.ward")}</div>}
          rules={[{ required: true }]}
        >
          <Select
            size="large"
        ...
        <S.FormField
          ...
          hasFeedback
          colon={false}
          label={<div className="font-bold">{t("admin_shop.shop_info.store_bus.address_detail")}</div>}
          rules={[{ required: true }]}
        >
          <Input size="large" />
        </S.FormField>
