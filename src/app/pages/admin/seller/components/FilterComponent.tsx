...
const sellerAdminTypeData = (t: any) => {
  return [
    ...
    {
      value: t("admin_shop.seller.filter.type.not_shop_admin"),
      label: t("admin_shop.seller.filter.type.not_shop_admin"),
    },
  ];
};
          ...
          <Col xs={24} lg={12}>
            <S.FilterTypeSpace size={8}>
              ...
              <FillerDrawer
                ...
                sellerTypeData={sellerTypeData(t)}
                profileStatusTypeData={profileStatusTypeData}
                sellerAdminTypeData={sellerAdminTypeData(t)}
              />
            </S.FilterTypeSpace>
          </Col>
